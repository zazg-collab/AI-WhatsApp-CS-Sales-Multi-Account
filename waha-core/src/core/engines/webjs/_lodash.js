/**
 * Almost original lodash
 * https://github.com/lodash/lodash/blob/main/dist/lodash.js
 * But with few modifications
 * 1. exports.LoadLodash
 * 2. window.lodash
 * 3. 'return _' at the end
 * 4. No 'call(this)' at the end, just call()
 */
exports.LoadLodash = () => {
  /**
   * @license
