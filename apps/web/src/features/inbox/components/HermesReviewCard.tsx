...
interface HermesReviewCardProps {
...
export function HermesReviewCard({ conversation }: HermesReviewCardProps) {
  const review = conversation.hermesReviews[0];

  if (!review) {
    return (
      <div className="border-b border-gray-200 p-4 dark:border-gray-800">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          No Hermes review for this conversation yet.
        </p>
      </div>
    );
  }
