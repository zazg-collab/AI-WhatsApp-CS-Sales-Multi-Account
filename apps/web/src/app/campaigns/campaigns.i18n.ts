...
export const dict: Dict = {
  ...
  campaignNamePlaceholder: { id: 'Nama campaign', en: 'Campaign name' },
  messagePlaceholder: { id: 'Pesan campaign… gunakan {{name}} / {{phone}} untuk personalisasi', en: 'Campaign message… use {{name}} / {{phone}} tokens' },
  accountDisconnectedMsg: { id: 'Akun terputus. ', en: 'Account disconnected. ' },
  reconnectLink: { id: 'Sambungkan di Accounts', en: 'Reconnect in Accounts' },
  accountDisconnectedHint: { id: ' sebelum mengirim.', en: ' before sending.' },
  ...
  rateHint: { id: 'Default 20 (aman anti-ban). Maks. 30/menit.', en: 'Default 20 (safe anti-ban). Max 30/min.' },
