      ...
      <aside className="w-64 shrink-0">
        ...
        <form onSubmit={createBase} className="mb-4 space-y-2">
          <input
            ...
            required
          />
          <button className="w-full rounded bg-wa-accent py-2 text-sm font-medium text-white">
            Buat
          </button>
        </form>
            ...
            <li key={b.id}>
              <button
                ...
                className={`w-full rounded px-3 py-2 text-left text-sm ${
                  selected === b.id ? 'bg-wa-accent text-white' : 'bg-white dark:bg-wa-panel'
                }`}
              >
                {b.name}{' '}
          ...
          <>
            ...
            <div className="mb-6 rounded-lg bg-white dark:bg-wa-panel p-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <label className={`cursor-pointer rounded bg-wa-accent px-3 py-2 text-sm font-medium text-white ${ingesting ? 'opacity-50' : ''}`}>
                ...
                <form onSubmit={handleUrlIngest} className="flex flex-1 gap-2">
                  ...
                  <button
                    ...
                    className="rounded bg-wa-accent px-3 py-2 text-sm font-medium text-white disabled:opacity-50"
                  >
                    Ambil URL
                  </button>
                </form>
            ...
            <form onSubmit={addItem} className="mb-6 space-y-2">
              ...
              <textarea
                ...
                required
              />
              <button className="rounded bg-wa-accent px-4 py-2 text-sm font-medium text-white">
                Tambah item
              </button>
            </form>
