...
export const dict: Dict = {
  ...
  colAvgFrt: { id: 'Avg. FRT', en: 'Avg. FRT' },
  colSample: { id: 'Sampel', en: 'Sample' },
  reopenRateByAccount: { id: 'Reopen Rate per Akun', en: 'Reopen rate per account' },
  colTotalResolved: { id: 'Total Selesai', en: 'Total resolved' },
  colReopen: { id: 'Reopen', en: 'Reopen' },
  colRate: { id: 'Rate', en: 'Rate' },
  sentimentTrend: { id: 'Tren Sentimen Customer', en: 'Customer sentiment trend' },
  colDate: { id: 'Tanggal', en: 'Date' },
  colAvgScore: { id: 'Avg. Skor', en: 'Avg. score' },
  colPositive: { id: 'Positif', en: 'Positive' },
  colNeutral: { id: 'Netral', en: 'Neutral' },
  colNegative: { id: 'Negatif', en: 'Negative' },
};
