...
export const dict: Dict = {
  ...
  qrStalled: { id: 'QR belum muncul. Coba mulai ulang sesi, lalu coba lagi.', en: "QR hasn't appeared. Try restarting the session, then try again." },
  noMatch: { id: 'Tidak ada akun yang cocok dengan filter.', en: 'No accounts match your filters.' },
  clearFilters: { id: 'Hapus filter', en: 'Clear filters' },
  phoneInvalid: { id: 'Nomor harus 8–15 digit.', en: 'Number must be 8–15 digits.' },
  ...
  profileTitle: { id: 'Profil WhatsApp', en: 'WhatsApp Profile' },
  profileSubtitle: { id: 'Ubah nama tampilan & status akun bot ini', en: "Edit this bot account's display name & status" },
  profileName: { id: 'Nama tampilan', en: 'Display name' },
  profileStatus: { id: 'Status / Info', en: 'Status / About' },
  profileStatusPlaceholder: { id: 'mis. Online 24 jam — balas cepat', en: 'e.g. Online 24/7 — quick replies' },
  profileAutoDetected: { id: 'Diambil dari WhatsApp — ubah bila perlu', en: 'Loaded from WhatsApp — edit if needed' },
  profileLoading: { id: 'Memuat profil…', en: 'Loading profile…' },
  profileSaved: { id: 'Tersimpan ✓', en: 'Saved ✓' },
  profileSaveFailed: { id: 'Gagal menyimpan profil. Pastikan akun terhubung.', en: 'Failed to save profile. Make sure the account is connected.' },
  wahaDownHint: {
    id: 'Sesi WhatsApp belum aktif. Coba mulai ulang akun atau periksa log server.',
    en: 'The WhatsApp session is not active. Try restarting the account or check the server logs.',
  },
  ...
  historySyncing: { id: 'Menyinkronkan riwayat… ({count} pesan)', en: 'Syncing history… ({count} messages)' },
  historySynced: { id: 'Riwayat tersinkron ({count} pesan)', en: 'History synced ({count} messages)' },
