...
// >>> ANGGA — F2 (2026-08-09, cowork): lapisan penjaga MURNI pindah ke
// `order-brain.ts` supaya bisa dipakai bersama produksi + test-harness.
// Di-re-export di bawah — jalur import lama tetap hidup, nol perubahan
// perilaku. <<<
import {
  formatIdr,
  POLA_TOKEN_TOTAL,
