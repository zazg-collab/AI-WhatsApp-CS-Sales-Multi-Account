...
//
// Kenapa dibalik — ini regresi yang lahir dari F4 sendiri dan hampir lolos.
// Sesudah F4, `susunBalasan` MEMASANG kalimat wajib di akhir. Kalau model
// masih disuruh menulisnya juga, ada satu jalur yang lebih buruk dari keadaan
// sebelum F4: model menulis PARAFRASE-nya (persis akar deadlock lama —
// "parafrase sedikit saja langsung tertahan"). Parafrase tidak dikenali
// pencocokan ternormalisasi, jadi tidak dibuang, lalu sistem menempelkan versi
// kanoniknya → pelanggan menerima pertanyaan yang sama DUA KALI, dan kali ini
// TERKIRIM, bukan tertahan. Menahan draft itu menyebalkan; mengirim pertanyaan
// dobel ke pelanggan itu memalukan.
//
// Dengan kepemilikan kalimat pindah SEPENUHNYA ke sistem, tidak ada lagi dua
// pihak yang menulis hal yang sama, dan kelas parafrase itu lenyap di sumbernya
